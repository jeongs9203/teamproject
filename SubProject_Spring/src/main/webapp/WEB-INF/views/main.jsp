...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">특별한 하루를 완성시키는<br> 가장 쉬운 방법</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">제철 식품과 시기에 맞춘 컨셉의 밀키트와 밀키트에 맞는 전통주 페어링을 만나보세요!</p>
                        <a class="btn btn-primary btn-xl" href="#about">더 자세히 보기</a>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">한 달에 한 번, 집 앞으로 찾아오는 인생술</h2>
                        <hr class="divider divider-light" />
                        <p class="text-white-75 mb-4">수많은 분들이 경험하고 있는 ‘굉장히 신경 쓴’ 구독서비스, 한번 구경해볼까요?!</p>
                        <a class="btn btn-light btn-xl" href="./subscribePage.sub">구독하러 가기!</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="page-section" id="services">
            <div class="container px-4 px-lg-5">
                <h2 class="text-center mt-0">신상술 10%</h2>
                <hr class="divider" />
        ...
        <section class="page-section bg-dark text-white">
            <div class="container px-4 px-lg-5 text-center">
                <h2 class="mb-4">4도부터 53도까지 다양하게 갖춰진 전통주 쇼핑몰</h2>
                <a class="btn btn-light btn-xl" href="storeMain.st">쇼핑하러 가기!</a>
            </div>
        </section>
        <!-- Contact-->
